...
public class SaladSlider : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (beginSlider == true)
        {
            ...
            if (timer >= slider.maxValue)
            {
                ...
                slider.value = 0;
                beginSlider = false;
                GameObject.Find("Salad Gen").GetComponent<FoodGen>().Salad = true;
            }
        }
    }
    ...
    public void BeginSlider()
    {
        if(bScript != null)
        {
            if (GameObject.Find("Salad Gen").GetComponent<FoodGen>().Salad == false && bScript.bOut == false && fScript.fireOut == false)
            {
                beginSlider = true;
        ...
        {
            if (GameObject.Find("Salad Gen").GetComponent<FoodGen>().Salad == false && fScript.fireOut == false)
            {
                beginSlider = true;
