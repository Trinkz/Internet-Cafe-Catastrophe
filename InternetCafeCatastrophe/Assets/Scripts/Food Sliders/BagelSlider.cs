...
public class BagelSlider : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (beginSlider == true)
        {
            ...
            if (timer >= slider.maxValue)
            {
                ...
                slider.value = 0;
                beginSlider = false;
                GameObject.Find("Bagel Gen").GetComponent<FoodGen>().Bagel = true;
            }
        }
    ...
    public void BeginSlider()
    {
        if(bScript != null)
        {
            if (GameObject.Find("Bagel Gen").GetComponent<FoodGen>().Bagel == false && bScript.bOut == false && fScript.fireOut == false)
            {
                beginSlider = true;
            }
        }
        ...
        {
            if (GameObject.Find("Bagel Gen").GetComponent<FoodGen>().Bagel == false && fScript.fireOut == false)
            {
                beginSlider = true;
            }
        }
