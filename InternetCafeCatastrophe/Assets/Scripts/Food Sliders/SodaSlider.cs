...
public class SodaSlider : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (beginSlider == true)
        {
            ...
            if (timer >= slider.maxValue)
            {
                ...
                slider.value = 0;
                beginSlider = false;
                GameObject.Find("Soda Gen").GetComponent<FoodGen>().Soda = true;
            }
        }
    }
    ...
    public void BeginSlider()
    {
        if(bScript != null)
        {
            if (GameObject.Find("Soda Gen").GetComponent<FoodGen>().Soda == false && bScript.bOut == false && fScript.fireOut == false)
            {
                beginSlider = true;
        ...
        {
            if (GameObject.Find("Soda Gen").GetComponent<FoodGen>().Soda == false && fScript.fireOut == false)
            {
                beginSlider = true;
