...
public class JanitorGenerator : MonoBehaviour
{
    ...
    {
        updateTimer();
        if (Input.GetKeyDown(KeyCode.J) && pauseG.isPaused == false && GameObject.FindObjectOfType<Tutorial>().Paused == false)
        {
        //    Debug.Log("I pressed J where is my Janitor?");
